...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec,
		Convert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec,
		...
		Convert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec,
		Convert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec,
		...
		Convert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec,
		Convert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec,
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.StorageTopologies != nil {
		...
		*out = make([]kops.StorageTopologySpec, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.StorageTopologies != nil {
		...
		*out = make([]StorageTopologySpec, len(*in))
		for i := range *in {
			if err := Convert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec(in *InstanceStoreArraySpec, out *kops.InstanceStoreArraySpec, s conversion.Scope) error {
	if in.MdadmOptions != nil {
		in, out := &in.MdadmOptions, &out.MdadmOptions
		*out = new(kops.MdadmOptionsSpec)
		if err := Convert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
...
// Convert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec is an autogenerated conversion function.
func Convert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec(in *InstanceStoreArraySpec, out *kops.InstanceStoreArraySpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec(in, out, s)
}

func autoConvert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec(in *kops.InstanceStoreArraySpec, out *InstanceStoreArraySpec, s conversion.Scope) error {
	if in.MdadmOptions != nil {
		in, out := &in.MdadmOptions, &out.MdadmOptions
		*out = new(MdadmOptionsSpec)
		if err := Convert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.MdadmOptions = nil
...
// Convert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec is an autogenerated conversion function.
func Convert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec(in *kops.InstanceStoreArraySpec, out *InstanceStoreArraySpec, s conversion.Scope) error {
	return autoConvert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec(in, out, s)
}
...
func autoConvert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec(in *MdadmOptionsSpec, out *kops.MdadmOptionsSpec, s conversion.Scope) error {
	out.Chunk = in.Chunk
	out.Force = in.Force
	out.Level = in.Level
...
// Convert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec is an autogenerated conversion function.
func Convert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec(in *MdadmOptionsSpec, out *kops.MdadmOptionsSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_MdadmOptionsSpec_To_kops_MdadmOptionsSpec(in, out, s)
}

func autoConvert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec(in *kops.MdadmOptionsSpec, out *MdadmOptionsSpec, s conversion.Scope) error {
	out.Chunk = in.Chunk
	out.Force = in.Force
	out.Level = in.Level
	out.Metadata = in.Metadata
...
// Convert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec is an autogenerated conversion function.
func Convert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec(in *kops.MdadmOptionsSpec, out *MdadmOptionsSpec, s conversion.Scope) error {
	return autoConvert_kops_MdadmOptionsSpec_To_v1alpha2_MdadmOptionsSpec(in, out, s)
}
...
func autoConvert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec(in *StorageTopologySpec, out *kops.StorageTopologySpec, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
	if in.InstanceStoreArray != nil {
		in, out := &in.InstanceStoreArray, &out.InstanceStoreArray
		*out = new(kops.InstanceStoreArraySpec)
		if err := Convert_v1alpha2_InstanceStoreArraySpec_To_kops_InstanceStoreArraySpec(*in, *out, s); err != nil {
			return err
		}
	} else {
...
// Convert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec is an autogenerated conversion function.
func Convert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec(in *StorageTopologySpec, out *kops.StorageTopologySpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_StorageTopologySpec_To_kops_StorageTopologySpec(in, out, s)
}

func autoConvert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec(in *kops.StorageTopologySpec, out *StorageTopologySpec, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
	if in.InstanceStoreArray != nil {
		in, out := &in.InstanceStoreArray, &out.InstanceStoreArray
		*out = new(InstanceStoreArraySpec)
		if err := Convert_kops_InstanceStoreArraySpec_To_v1alpha2_InstanceStoreArraySpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.InstanceStoreArray = nil
...
// Convert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec is an autogenerated conversion function.
func Convert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec(in *kops.StorageTopologySpec, out *StorageTopologySpec, s conversion.Scope) error {
	return autoConvert_kops_StorageTopologySpec_To_v1alpha2_StorageTopologySpec(in, out, s)
}
