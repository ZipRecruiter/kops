...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BootstrapScriptSpec)(nil), (*kops.BootstrapScriptSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec(a.(*BootstrapScriptSpec), b.(*kops.BootstrapScriptSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.BootstrapScriptSpec)(nil), (*BootstrapScriptSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec(a.(*kops.BootstrapScriptSpec), b.(*BootstrapScriptSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec(in *BootstrapScriptSpec, out *kops.BootstrapScriptSpec, s conversion.Scope) error {
	out.Name = in.Name
	out.URL = in.URL
	out.Hash = in.Hash
	return nil
...
// Convert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec is an autogenerated conversion function.
func Convert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec(in *BootstrapScriptSpec, out *kops.BootstrapScriptSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec(in, out, s)
}

func autoConvert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec(in *kops.BootstrapScriptSpec, out *BootstrapScriptSpec, s conversion.Scope) error {
	out.Name = in.Name
	out.URL = in.URL
	out.Hash = in.Hash
	return nil
...
// Convert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec is an autogenerated conversion function.
func Convert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec(in *kops.BootstrapScriptSpec, out *BootstrapScriptSpec, s conversion.Scope) error {
	return autoConvert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec(in, out, s)
}
...
func autoConvert_v1alpha1_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.BootstrapScripts != nil {
		...
		*out = make([]kops.BootstrapScriptSpec, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_BootstrapScriptSpec_To_kops_BootstrapScriptSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_ClusterSpec_To_v1alpha1_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.BootstrapScripts != nil {
		...
		*out = make([]BootstrapScriptSpec, len(*in))
		for i := range *in {
			if err := Convert_kops_BootstrapScriptSpec_To_v1alpha1_BootstrapScriptSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
